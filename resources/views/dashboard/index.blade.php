...
@section('body')
    ...
    <div class="col-md-8 container-flex">
        <iframe id="video" width="700" height="400" src="https://www.youtube.com/embed/E4K7sqFsQ-k?autoplay=1"
                frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
    </div>
    <div class="col-md-4" id="container">
        <h4>Danh sách phim</h4>
        @foreach($newEposide as $eps)
            <div class="item-video">
                <div onclick="editSrc('https://www.youtube.com/embed/{{$eps->id_youtobe}}')" class="col-md-4">
                    <img onclick="editSrc('https://www.youtube.com/embed/dkFnNB-s-G4')" id="img"
                         class="style-scope yt-img-shadow" alt="" width="100" src="{{$eps->image}}">
                </div>
                <div class="col-md-8">
